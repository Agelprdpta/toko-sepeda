    ...
    <div class="card w-100 text-dark ">
        ...
        <form class="ml-3" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <select class="form-control" name="kategori" id="kategori">
                        <option>--Pilih--</option>
                        <option value="sepeda_lipat">Sepeda Lipat</option>
                        <option value="sepeda_fixie">Sepeda Fixie</option>
                        <option value="sepeda_gunung">Sepeda Gunung</option>
                    </select>
                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                </div>
                <div class="form-group mx-2 col-sm-5 ">
            ...
            <div class=" text-center my-3">
                ...
                <a href="<?= url ?>admin/produk.php/?id=<?= isset($produk['produk']) ? $produk['produk']->id_produk : '' ?>" class="btn btn-sm btn-danger w-25" class="card-link">Batal</a>
            </div>
        </form>
    </div>
</div>
