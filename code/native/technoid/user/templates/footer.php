        ...
        <div class="row px-5 py-3">
            <div class="col-sm ">
                ...
                <p class="foot-item ml-3">
                    <a href="<?= url ?>user/produk.php/?kategori=sepeda_lipat">Sepeda Lipat</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=sepeda_fixie">Sepeda Fixie</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=sepeda_gunung">Sepeda Gunung</a><br>
                </p>
            </div>
            <div class="col-sm ">
                <h6>Halaman</h6>
