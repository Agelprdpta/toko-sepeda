...
// Ambil keranjang dan inisialisasi subtotal
$cart = ambilCart()['carts'];
$subtotal = 0; // Inisialisasi subtotal sebagai 0

// Iterasi keranjang untuk menghitung total setiap item dan subtotal
foreach ($cart as $item) {
    // Hitung total harga per item berdasarkan kuantiti
    $item->total = $item->harga * $item->kuantiti;
            ...
            <div class="tab-pane fade" id="keranjang" role="tabpanel" aria-labelledby="tab-keranjang">
                <table class="table table-striped">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <form action="" method="POST">
                                <td colspan="6"><button name="bersihkanCart" class="btn btn-sm btn-success">Bersihkan isi keranjang</button></td>
                            </form>
